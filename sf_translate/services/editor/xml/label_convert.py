...
from sf_translate.services.xml import LabelConvertXML
...
class LabelConvertXMLEditor(IEditor):
    def __init__(
        self,
        ...
        self._xml = LabelConvertXML(input_path, output_path, target_lang, source_lang)
        self._max_workers = max_workers

    def _edit(self, chunk: TranslateChunk):
        label = chunk.chunk.find(".//{http://soap.sforce.com/2006/04/metadata}label")
