...
from sf_translate.services.xml import TranslationConvertXML
...
class TranslationConvertXMLEditor(IEditor):
    def __init__(
        self,
        ...
        self._xml = TranslationConvertXML(input_path, output_path, target_lang, source_lang)
