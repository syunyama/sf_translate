...
from sf_translate.services.xml import StandardValueXML
...
class StandardValueXMLEditor(IEditor):
    def __init__(
        self,
        ...
        self._xml = StandardValueXML(input_path, output_path, target_lang, source_lang)
        self._max_workers = max_workers

    def _edit(self, chunk: TranslateChunk):
        label = chunk.chunk.find("translation")
